                                        ...
                                        <form method="post">
                                            <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" style="text-transform: capitalize;" required="required" name="pat_fname" class="form-control" id="pat_fname" placeholder="Patient's First Name" readonly>
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="pat_mname" class="col-form-label">Middle Name</label>
                                                    <input type="text" style="text-transform: capitalize;" required="required" name="pat_mname" class="form-control" id="pat_mname" placeholder="Patient's Middle Name" readonly>
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="pat_lname" class="col-form-label">Last Name</label>
                                                    <input required="required" style="text-transform: capitalize;" type="text" name="pat_lname" class="form-control"  id="pat_lname" placeholder="Patient`s Last Name" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <input type="date" required="required" name="pat_dob" class="form-control" id="pat_dob" placeholder="MM/DD/YYYY" readonly>
                                                </div>
                                                ...
                                                <div class="form-group col-md-2">
                                                    ...
                                                    <input type="text" name="pat_sex" id="pat_sex" class="form-control" readonly>
                                                </div>
                                                <div class="form-group col-md-2"> 
                                                    <label for="pat_civil_status" class="col-form-label">Civil Status</label>
                                                    <input name="pat_civil_status" id="pat_civil_status" class="form-control"  readonly>
                                                </div>
                                                
                                                <div class="form-group col-md-3">
                                                    <label for="pat_nationality" class="col-form-label">Nationality</label>
                                                    <input required="required" type="text" name="pat_nationality" class="form-control" id="pat_nationality" style="text-transform: capitalize; " placeholder="Patient's Nationality"  readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-8">
                                                    ...
                                                    <input required="required" style="text-transform: capitalize;" type="text" class="form-control" name="pat_addr" id="pat_addr" placeholder="Patient's Addresss" readonly>
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="pat_phone" class="col-form-label">Mobile Number</label>
                                                    <input required="required" type="tel" name="pat_phone" class="form-control" id="pat_phone" placeholder="Patient's Mobile Number" readonly>
                                                </div>
                                            </div>
                                            <hr>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input required="required" type="text" name="pat_employer" class="form-control" id="pat_employer" placeholder="Patient's Employer" readonly>
                                                </div>

                                                <div class="form-group col-md-4">
                                                    <label for="pat_employer_mobile" class="col-form-label">Mobile Number</label>
                                                    <input required="required" type="tel" name="pat_employer_mobile" class="form-control" id="pat_employer_mobile" placeholder="Employer's Mobile Number" readonly>
                                                </div>

                                                <div class="form-group col-md-2"> 
                                                    <label for="notified_authority" class="col-form-label">Notified Proper Authority</label>
                                                    <input name="notified_authority" id="notified_authority" class="form-control" required="required" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" name="date_time_registration" class="form-control" id="date_time_registration" required="required"  readonly>
                                                </div>

                                                <div class="form-group col-md-4">
                                                    <label for="brought_by" class="col-form-label">Brought By</label>
                                                    <input name="brought_by" id="brought_by" class="form-control" required="required"  readonly>
                                                </div>

                                                <div class="form-group col-md-4">
                                                    <label for="brought_by_mobile" class="col-form-label">Mobile Number</label>
                                                    <input required="required" type="tel" name="brought_by_mobile" class="form-control" id="brought_by_mobile" placeholder="Mobile Number" readonly>
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="form-row">
