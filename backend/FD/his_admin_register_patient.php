...
<?php
    ...
    include('assets/inc/config.php');
        if(isset($_POST['add_patient']))
        {
            ...
            $query = "INSERT INTO his_patients(pat_fname,pat_lname,pat_dob,pat_age,pat_number,pat_addr,wardnumber,bednumber,pat_phone,pat_type,pat_date_joined,pat_ailment,pat_discharge_status,status) 
                VALUES('$pat_fname', '$pat_ailment','$pat_dob','$pat_age','$pat_number','$pat_addr','','','$pat_phone','$pat_type','$date','$pat_ailment','','1')";
                                        ...
                                        <form method="post">
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" style="text-transform: capitalize;" required="required" name="pat_fname" class="form-control" id="inputEmail4" placeholder="Patient's First Name">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="inputPassword4" class="col-form-label">Last Name</label>
                                                    <input required="required" style="text-transform: capitalize;" type="text" name="pat_lname" class="form-control"  id="inputPassword4" placeholder="Patient`s Last Name">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input required="required" style="text-transform: capitalize;" type="text" class="form-control" name="pat_addr" id="inputAddress" placeholder="Patient's Addresss">
                                            </div>
