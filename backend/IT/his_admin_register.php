                            ...
                            <div class="card-body p-4">
                                ...
                                <form  method='post'>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" style="text-transform: capitalize;"  name = "ad_fname" id="fullname" placeholder="Enter your name" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="fullname">Last Name</label>
                                        <input class="form-control" type="text" style="text-transform: capitalize;" name="ad_lname" id="fullname" placeholder="Enter your name" required>
                                    </div>
                                    <div class="form-group">
