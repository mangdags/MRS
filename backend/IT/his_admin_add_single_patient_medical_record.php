...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_patient_mdr']))
		{
			...
			$query="INSERT INTO  his_medical_records  (mdr_pat_name, mdr_pat_number, mdr_pat_adr, mdr_pat_age, mdr_number, mdr_pat_prescr, mdr_pat_ailment,status) VALUES('$mdr_pat_name','$mdr_pat_number', '$mdr_pat_adr', '$mdr_pat_age', '$mdr_number', '$mdr_pat_prescr', '$mdr_pat_ailment', 1)";
			...
			*/ 
			...
			if($stmt)
			{
                ...
                $changes = 'Add medical record of '.$mdr_pat_name.'';
