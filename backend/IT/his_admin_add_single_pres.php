...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_patient_presc']))
		{
			...
			$query="INSERT INTO  his_prescriptions  (pres_pat_name, pres_pat_number, pres_pat_type, pres_pat_addr, pres_pat_age, pres_number, pres_pat_ailment, pres_ins,status) VALUES('$pres_pat_name','$pres_pat_number','$pres_pat_type','$pres_pat_addr', '$pres_pat_age','$pres_number','$pres_pat_ailment','$pres_ins',1)";
			...
			*/ 
			...
			if($stmt)
			{
                ...
                $changes = 'Add Prescription to patient '.$pres_pat_name.'<br> Prescription: '.$pres_ins.'';
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="post">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <input  readonly type="hidden" name="pres_pat_type" value="<?php echo $row->pat_type;?>" class="form-control"  id="inputPassword4" placeholder="Patient`s Age">
                                                    </div>
                                                ...
                                                <div class="form-group ">
                                                        ...
                                                        <input required="required" type="text" value="<?php echo $row->pat_ailment;?>" name="pres_pat_ailment" readonly class="form-control" id="inputCity">
                                                </div>
                                                <hr>
                                                <div class="form-row">
