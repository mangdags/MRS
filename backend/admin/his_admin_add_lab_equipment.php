...
<?php
	...
	include('assets/inc/config.php');
        ...
        
        {
			...
			$query="INSERT INTO his_equipments (eqp_code, eqp_name, eqp_vendor, eqp_desc, eqp_dept, eqp_status, eqp_qty,status) 
                            VALUES ('$eqp_code','$eqp_name','$eqp_vendor','$eqp_desc','$eqp_dept','$eqp_status','$eqp_qty',1)";
			...
			*/ 
			...
			if($stmt)
			{
                ...
                $changes = 'Add Lab Equipment <br>Name'.$eqp_name.'<br>Vendor: '.$eqp_vendor.'<br>Quantity: '.$eqp_qty.'';
