...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_emp_vitals']))
		{
			...
			$rc=$stmt->bind_param('ssssss', $vit_number, $ad_id, $vit_bodytemp, $vit_heartpulse, $vit_resprate, $vit_bloodpress);
			$stmt->execute();
			/*
			...
			*/ 
			...
			if($stmt)
			{
                ...
                $changes = 'Capture vitals of employee '.$_POST['name'].'<br> Temperature : '.$vit_bodytemp.'<br>Heart Pulse: '.$vit_heartpulse.'<br>Respiratory Rate bpm: '.$vit_resprate.'<br>Blood Pressure mmHg: '.$vit_bloodpress.'';
...
<html lang="en">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <?php
                $ad_id = $_GET['ad_id'];
                $ret = "SELECT  * FROM his_admin WHERE ad_id=". $ad_id;
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title">Capture <?php echo $row->ad_fname;?> <?php echo $row->ad_lname;?> Vitals</h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                            ...
                                            <form method="post">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" required="required" readonly name="name" value="<?php echo $row->ad_fname;?> <?php echo $row->ad_lname;?>" class="form-control" id="inputEmail4" placeholder="Patient's First Name">
                                                    </div>

                                                    <div class="form-group col-md-6">
                                                        <label for="inputPassword4" class="col-form-label">Employee Department</label>
                                                        <input required="required" type="text" readonly name="" value="
                                                        <?php 
                                                            if (($row->status)== 2) {
                                                                echo 'Doctor';
                                                            }
