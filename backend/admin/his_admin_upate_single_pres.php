	...
	include('assets/inc/config.php');
		if(isset($_POST['update_patient_presc']))
		{
			...
			*/ 
			...
			if($stmt)
			{
                if ($_POST['pres'] != $pres_ins) {
                    $id_user = $_SESSION['ad_id'];
                    $changes = 'Change Prescription of '.$pres_pat_name.'<br> Changes: '.$pres_ins.' To '.$_POST['pres'].'';
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="post">
                                                ...
                                                <div class="form-group ">
                                                        ...
                                                        <input required="required" readonly type="text" value="<?php echo $row->pres_pat_ailment;?>" name="pres_pat_ailment" class="form-control" id="inputCity">
                                                </div>
                                                <hr>
                                                ...
                                                <input type="hidden" name="pres" value="<?php echo $row->pres_ins;?>">
