		...
		if(isset($_POST['add_patient_vitals']))
		{
			...
			*/ 
			...
			if($stmt)
			{
                ...
                $changes = 'Capture vitals of patient '.$pat_name.'<br> Temperature : '.$vit_bodytemp.'<br>Heart Pulse: '.$vit_heartpulse.'<br>Respiratory Rate bpm: '.$vit_resprate.'<br>Blood Pressure mmHg: '.$vit_bloodpress.'';
                                            ...
                                            <form method="post">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" required="required" readonly name="pat_name" value="<?php echo $row->pat_fname;?> <?php echo $row->pat_lname;?>" class="form-control" id="inputEmail4" placeholder="Patient's First Name">
                                                    </div>
