                        ...
                        <div class="row">
                            <div class="col-lg-6 col-xl-6">
                                <div class="card-box text-center">
                                    <img src="../doc/assets/images/users/<?php echo $row->ad_dpic;?>" class="rounded-circle avatar-lg img-thumbnail"
                                        alt="profile-image">
                                    ...
                                    <div class="text-centre mt-3">
                                       ...
                                       <p class="text-muted mb-2 font-13"><strong>Department :</strong> <span class="ml-2">
                                        <?php if (($row->status) == 2) {
                                            echo 'Doctor';
                                            }
                                            elseif (($row->status) == 3) {
                            ...
                            <div class="col-lg-6 col-xl-6">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover mb-0">
                                        ...
                                        <?php
                                            $ret="SELECT * FROM his_vitals WHERE vit_pat_number = '$ad_id'";
                                            $stmt= $mysqli->prepare($ret) ;
