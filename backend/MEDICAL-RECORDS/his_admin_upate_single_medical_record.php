	...
	include('assets/inc/config.php');
		if(isset($_POST['update_patient_mdr']))
		{
			...
			*/ 
			...
			if($stmt)
			{
                if ($_POST['pres'] != $mdr_pat_prescr) {
                    $id_user = $_SESSION['ad_id'];
                    $changes = 'Change Prescription of '.$mdr_pat_name.'<br> Changes: '.$_POST['pres'].' To '.$mdr_pat_prescr.'';
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form method="post">
                                                ...
                                                <input type="hidden" name="pres" value="<?php echo $row->mdr_pat_prescr;?>">
                                                <?php }?>
