...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_patient_lab_test']))
		{
			...
			$query="INSERT INTO  his_laboratory  (lab_pat_name, lab_pat_ailment, lab_pat_number, lab_pat_tests, lab_number,image ) 
                                            VALUES('$lab_pat_name','$lab_pat_ailment','$lab_pat_number','$lab_pat_tests','$lab_number','$doc_dpic')";
